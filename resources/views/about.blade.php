  ...
  <div class="container">
    <div class="row gy-3 gy-md-4 gy-lg-0 align-items-lg-center">
      <div class="col-12 col-lg-6 col-xl-5">
        <img class="img-fluid rounded" loading="lazy" src="https://images.pexels.com/photos/13316856/pexels-photo-13316856.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" alt="About 1">
      </div>
      <div class="col-12 col-lg-6 col-xl-7">
        <div class="row justify-content-xl-center">
          <div class="col-12 col-xl-11">
            <h2 class="mb-3">Welcome to Jarred Style Haven</h2>
            <p class="lead fs-4 text-secondary mb-3"></p>
            <p class="mb-5">At Jarred Style Haven, we believe that fashion is more than just clothing—it's a statement of your unique style and personality. Our online store is dedicated to offering a curated selection of high-quality, stylish apparel that caters to your every need. Whether you're looking for the perfect polo shirt, a comfortable pair of pants, a versatile t-shirt, or a sleek long-sleeve shirt, we have you covered.</p>
            <div class="row gy-4 gy-md-0 gx-xxl-5X">
              <div class="col-12 col-md-6">
                <div class="d-flex">
                  ...
                  <div>
                    <h2 class="h4 mb-3">Quality</h2>
                    <p class="text-secondary mb-0">We prioritize high-quality materials and craftsmanship in every piece we offer, ensuring durability and a premium feel.</p>
                  </div>
                </div>
              </div>
              <div class="col-12 col-md-6">
                <div class="d-flex">
                  ...
                  <div>
                    ...
                    <p class="text-secondary mb-0">Our collections are carefully curated to reflect the latest trends while maintaining timeless appeal.</p>
                  </div>
                </div>  
              </div>
              <div class="col-12 col-md-6">
                <div class="d-flex">
                  ...
                  <div>
                    <br>
                    <h2 class="h4 mb-3">Customer Service:</h2>
                    <p class="text-secondary mb-0"> Your satisfaction is our top priority. Our dedicated customer service team is here to assist you with any queries or concerns.</p>
                  </div>
                </div>  
              </div>
              <div class="col-12 col-md-6">
                <div class="d-flex">
                  ...
                  <div>
                    <br>
                    <h2 class="h4 mb-3">Comfort</h2>
                    <p class="text-secondary mb-0">We believe that looking good should also feel good. Our clothing is designed for maximum comfort without compromising on style.</p>
                  </div>
                </div>  
              </div>
            </div>
